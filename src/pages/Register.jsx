...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex w-full bg-[#FAF8F5] animate-fade-in">
      ...
      {/* Right side - Form */}
      <div className="w-full lg:w-1/2 flex flex-col p-8 sm:p-12 lg:px-24 xl:px-32 justify-center">
        <div className="w-full max-w-md mx-auto">
          ...
          <form className="space-y-6" onSubmit={handleSubmit} noValidate>
            <div>
              <label className="block text-[10px] font-bold text-[#8B8B88] uppercase tracking-wider mb-2">
                Full Name
              </label>
              <input
                type="text"
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pb-3 bg-transparent border-b border-[#D8D2C8] text-[#2D2D2A] focus:border-[#2D2D2A] focus:outline-none transition-colors text-[0.95rem]"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-0 bottom-3 text-[#8B8B88] hover:text-[#2D2D2A] transition-colors"
              >
            ...
            <div className="flex items-center gap-3 pt-2">
              <div className="relative flex items-center">
                <input
                  ...
                  className="peer appearance-none w-4 h-4 border border-[#D8D2C8] rounded-sm checked:bg-[#4A533D] checked:border-[#4A533D] focus:outline-none focus:ring-2 focus:ring-[#4A533D]/20 transition-all cursor-pointer"
                />
                <svg
                  className="absolute left-0 top-0 w-4 h-4 pointer-events-none opacity-0 peer-checked:opacity-100 text-white transition-opacity p-[2px]"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="3"
              ...
              <label htmlFor="terms" className="text-[0.85rem] text-[#5C5C58] cursor-pointer hover:text-[#2D2D2A] transition-colors">
            ...
            <button
              type="submit"
              className="w-full py-3.5 mt-4 bg-[#4A533D] hover:bg-[#3D4532] text-white rounded-xl font-semibold text-[0.95rem] transition-colors shadow-sm"
            >
              Create Account
            </button>
          </form>

...
| Planning | กำหนดขอบเขตระบบและแบ่งหน้าที่ |
| Analysis | รวมข้อมูล วิเคราะห์การทำงาน ออกแบบ use case class diagram |
| Design | ออกแบบผ่านโปรแกรม figma wir frame |
| Development | เขียนfrontendและเชียนbackend |
| Testing | ทดสอบทุกการทำงานของระบบทุกactor |
| Deployment | จำลองการใช้งานจริง |
| Maintenance | ปรับปรุงตามข้อเสนอแนะ |

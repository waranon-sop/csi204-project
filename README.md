...
- [หมวดการประเมินที่ 1: การเสนอและอนุมัติโครงงาน](#หมวดการประเมินที่-1-การเสนอและอนุมัติโครงงาน-project-proposal)
- [หมวดการประเมินที่ 2: การวิเคราะห์และออกแบบระบบ](#หมวดการประเมินที่-2-การวิเคราะห์และออกแบบระบบ-system-analysis-and-design)
- [การวิเคราะห์โครงสร้างของระบบตาม SDLC](#การวิเคราะห์โครงสร้างของระบบตาม-sdlc-system-development-life-cycle)
...
## หมวดการประเมินที่ 1: การเสนอและอนุมัติโครงงาน (Project Proposal)

**1. ปัญหาและความสำคัญ (Rationale)**
การขายเสื้อผ้ามือสองผ่านทางช่องทางโซเชียลมีเดียที่มีอยู่ ผู้ขายมักประสบปัญหาลูกค้าพิมพ์ CF สินค้าชิ้นเดียวกันพร้อมกัน ทำให้จัดการลำบาก ปิดการขายยาก และมีข้อผิดพลาดสูง การมีแพลตฟอร์ม e-Commerce เฉพาะสำหรับเสื้อผ้ามือสองจะช่วยแก้ปัญหานี้ ลดความผิดพลาด และช่วยให้ร้านค้าน่าเชื่อถือเข้าถึงได้ง่ายขึ้น

**2. วัตถุประสงค์ของโครงงาน (Objectives)**
1. นำความรู้เรื่อง Next.js และ Local Storage มาประยุกต์พัฒนาระบบให้ใช้งานได้จริง
2. แก้ปัญหาสำหรับผู้ที่ซื้อซ้ำซ้อน และลูกค้าหลายคน
3. เพื่อสร้างเว็บไซต์ e-Commerce สำหรับเสื้อผ้ามือสอง

**3. การกำหนดผู้ใช้งานและความต้องการระบบ (System Scope)**
- **ผู้ใช้งาน (Actors):**
  - ลูกค้า (Customer)
  - พนักงาน (Staff)
  - ผู้ดูแลระบบ (Administrator)
- **ความสามารถหลักของระบบ (Main Functions):**
  1. **ระบบจัดการสมาชิก:** ลงทะเบียน เข้าสู่ระบบ และจัดการข้อมูลส่วนตัว
  2. **ระบบหน้าร้าน:** ลูกค้าสามารถค้นหาสินค้า ดูรายละเอียด และสั่งซื้อได้
  3. **ระบบตะกร้าสินค้าและการสั่งซื้อ:** ลูกค้าสามารถเพิ่มสินค้าลงตะกร้าและสั่งซื้อได้
  4. **ระบบจัดการสินค้า:** ผู้ดูแลระบบสามารถเพิ่ม/ลบ/แก้ไขข้อมูลสินค้า
  5. **ระบบสรุปและรายงานผล:** ดูสรุปยอดขายและสถิติต่างๆ ผ่าน Dashboard ได้
...
*(หมายเหตุ: สามารถดูรายละเอียดและรูปภาพของแต่ละหัวข้อได้ที่เอกสาร [Analysis & Design](docs/analysis-design.md))*
...
## การวิเคราะห์โครงสร้างของระบบตาม SDLC (System Development Life Cycle)

| ขั้นตอน (Phase) | รายละเอียดโดยย่อ (Brief Description) |
| :--- | :--- |
| **1. Planning (การวางแผน)** | กำหนดขอบเขตของแพลตฟอร์ม ศึกษาความเป็นไปได้ และแบ่งหน้าที่รับผิดชอบภายในทีม |
| **2. Analysis (การวิเคราะห์)** | รวบรวมความต้องการของระบบ วิเคราะห์กระบวนการทำงาน รวมถึงออกแบบ Use Case และ Class Diagram |
| **3. Design (การออกแบบ)** | ออกแบบส่วนต่อประสานกับผู้ใช้ (UI/UX) และสร้าง Wireframe/Prototype ผ่านโปรแกรม Figma |
| **4. Development (การพัฒนา)** | ดำเนินการเขียนโปรแกรม โดยพัฒนาทั้งส่วนหน้าบ้าน (Frontend) ด้วย Next.js และหลังบ้าน (Backend) |
| **5. Testing (การทดสอบ)** | ทดสอบการทำงานของระบบในทุกฟังก์ชันและทุกกลุ่มผู้ใช้งาน (Customer, Staff, Admin) เพื่อตรวจสอบหาข้อบกพร่อง |
| **6. Deployment (การติดตั้งระบบ)** | นำระบบขึ้นโฮสต์เพื่อเปิดใช้งานและจำลองการทำงานบนสภาพแวดล้อมจริง |
| **7. Maintenance (การบำรุงรักษา)** | ติดตามผลการใช้งาน รับฟังข้อเสนอแนะ และปรับปรุงแก้ไขระบบให้มีประสิทธิภาพอย่างต่อเนื่อง |
...
| C05 | Reviews | เขียนรีวิวสำหรับสินค้าที่จัดส่งสำเร็จ | Pass |
| C06 | Wardrobe | บันทึกหรือลบสินค้าที่ชื่นชอบในรายการตู้เสื้อผ้าส่วนตัว | fail |
| C07 | Eco-Impact | แดชบอร์ดสรุปสถิติรักษ์โลก | Pass |
| C08 | Missions | ทำภารกิจรายวันและสะสมแต้มอัตโนมัติเมื่อสั่งซื้อถึงเกณฑ์ | Pass |
| C09 | Profile | แก้ไขข้อมูล, รหัสผ่าน, รูปโปรไฟล์ | fail |
...
| รหัส | หมวดหมู่ | การทดสอบ (Test Case) | สถานะ |
|:---:|---|---|:---:|
| S01 | Role Guard | บล็อกเมื่อพยายามเข้า URL ของ Admin โดยตรง | Pass |
| S02 | Inventory | เพิ่มหรือแก้ไขข้อมูลสินค้า| Pass |
| S03 | Inventory | เปลี่ยนสถานะสินค้า (Draft, Available, Sold Out, Reserved) | Pass |
| S04 | Orders | ดูรายการสั่งซื้อและปรับสถานะออเดอร์ | Pass |
| S05 | Promotions | สร้าง แก้ไข ปิดเปิดโค้ดส่วนลด และนำไปใช้จริงในหน้า Checkout | Pass |
| S06 | Profile | อัปเดตข้อมูลพนักงาน | Pass |
...
| รหัส | หมวดหมู่ | การทดสอบ (Test Case) | สถานะ |
|:---:|---|---|:---:|
| A01 | Authentication |เข้าถึง Dashboard ได้ครบถ้วน | Pass |
| A02 | Dashboard | ดึงสถิติยอดขาย กราฟรายได้ และ Activity Log มาแสดงผลได้จริง | Pass |
| A03 | Users | จัดการรายชื่อผู้ใช้ และสามารถปรับเปลี่ยน Role (Customer ↔ Staff) ได้ | Pass |
| A04 | Lookbooks | สร้างหรือแก้ไขชุดแฟชั่นโปรโมตที่หน้าแรก | Pass |
| A06 | Settings | บันทึกตั้งค่าร้านค้า (ค่าส่งฟรีเมื่อซื้อครบ, Eco-Rate) ไปใช้จริง | fail |

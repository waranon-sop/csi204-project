...
- [1. Persona Design](#1-persona-design)
- [2. Use Case Diagram](#2-use-case-diagram)
- [3. Class Diagram](#3-class-diagram)
- [4. Sequence Diagram](#4-sequence-diagram)
- [5. Wireframe / Prototype](#5-wireframe--prototype)
- [6. Data Schema (JSON)](#6-data-schema-json)
- [7. System Architecture](#7-system-architecture)
- [8. ข้อมูลเพิ่มเติมของระบบ (Additional System Info)](#8-ข้อมูลเพิ่มเติมของระบบ-additional-system-info)

---

## 1. Persona Design

### 1.1 Persona 1: Customer (ลูกค้า)
...
### 1.3 Persona 3: Administrator (ผู้ดูแลระบบ)
...
[Figma Design](https://www.figma.com/design/1K2hJcSxbNVsy1EvjIkmAZ/Re-wear?node-id=0-1&p=f&t=ZE52yZWB8HONY6yu-0)
...
## 8. ข้อมูลเพิ่มเติมของระบบ (Additional System Info)

### 8.1 ภาพรวมระบบ (System Overview)
...
### 8.2 ความต้องการของระบบ (Requirement Analysis)
